...
>>>>>>> b75c208 (Fixed alarm ot setting for curret time.)
            }
        }
    }
    ...
    func setupAudioPlayers() {
        guard let wristwatchURL = Bundle.main.url(forResource: "alarm-clock-short-6402", withExtension: "aif"), // Changed wristwatch soud to alarm-clock-short-6402
